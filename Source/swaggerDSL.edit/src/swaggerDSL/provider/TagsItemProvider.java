...
/**
 * This is the item provider adapter for a {@link swaggerDSL.Tags} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TagsItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tags_tag_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tags_tag_feature", "_UI_Tags_type"),
				 SwaggerDSLPackage.Literals.TAGS__TAG,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Tags)object).getTag();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Tags.class)) {
			case SwaggerDSLPackage.TAGS__TAG:
