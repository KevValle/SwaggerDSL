...
/**
 * This is the item provider adapter for a {@link swaggerDSL.Properties} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertiesItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Properties_propertyName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Properties_propertyName_feature", "_UI_Properties_type"),
				 SwaggerDSLPackage.Literals.PROPERTIES__PROPERTY_NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SwaggerDSLPackage.Literals.PROPERTIES__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SwaggerDSLPackage.Literals.PROPERTIES__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Properties)object).getPropertyName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Properties.class)) {
			case SwaggerDSLPackage.PROPERTIES__PROPERTY_NAME:
			case SwaggerDSLPackage.PROPERTIES__TYPE:
			case SwaggerDSLPackage.PROPERTIES__DESCRIPTION:
